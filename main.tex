...
\usepackage{pgf, tikz}      % graphe des états
...
~\\
This really is how this job works. So we managed to get \textit{Hadoop Pipes} working and we -- almost -- wrote our first job. In the next section, we will see how to use \textit{Hadoop Pipes} and \textit{ROS} for writing our jobs.
